...
class Scene:
    ...
    def __init__(self, width, height):
        ...
        envmaps[0] = ktxobject.ktx_load("equirectangularmap1.ktx")
    ...
    def display(self):
        ...
        m3dRotationMatrix44(RX, m3dDegToRad(0), 1.0, 0.0, 0.0)
...
if __name__ == '__main__':
    ...
    w1 = glutCreateWindow('OpenGL SuperBible - Equirectangular Environment Map')
