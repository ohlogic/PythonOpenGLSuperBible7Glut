...
'''
    ...
    def display(self):
        ...
        scissor_width = (7 * self.width) / 16
        scissor_height = (7 * self.height) / 16

        #// Four rectangles - lower left first...
        glScissorIndexed(0,
                         0, 0,
                         int(scissor_width), int(scissor_height))

        #// Lower right...
        glScissorIndexed(1,
                         int(self.width - scissor_width), 0,
                         int(scissor_width), int(scissor_height))

        #// Upper left...
        glScissorIndexed(2,
                         0, int(self.height - scissor_height),
                         int(scissor_width), int(scissor_height))

        #// Upper right...
        glScissorIndexed(3,
                         int(self.width - scissor_width),
                         int(self.height - scissor_height),
                         int(scissor_width), int(scissor_height))
...
if __name__ == '__main__':
    ...
    w1 = glutCreateWindow('OpenGL SuperBible - Multiple Scissors')
